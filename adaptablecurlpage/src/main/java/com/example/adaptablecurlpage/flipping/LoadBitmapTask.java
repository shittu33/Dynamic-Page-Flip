...
//        };
        PageRender.setMaxPages(mPortraitBGs[mBGSizeIndex].length);
    }
...
/*        Bitmap b = null;
        ...
        if (b == null) {
            ...
            b = getRandomBitmap(index);
        }
*/

        return getRandomBitmap(index);
    }
    ...
    private Bitmap getRandomBitmap(int index) {
        ...
        mPreRandomNo = newNo;*/
        index = index;
        int resId = mPortraitBGs[mBGSizeIndex][index];
