...
private static boolean UseDominantColorForFoldBack = true;
    ...
    public static void setFoldPageBackColor(int foldPageBackColor) {
        FoldPageBackColor = foldPageBackColor;
    }

    public void setFirstTexture(Bitmap b) {
        if (UseDominantColorForFoldBack){
            // compute mask color
            ...
            int color = FoldPageBackColor;
            maskColor[FIRST_TEXTURE_ID][0] = Color.red(color) ;
            maskColor[FIRST_TEXTURE_ID][1] = Color.green(color);
            maskColor[FIRST_TEXTURE_ID][2] = Color.blue(color) ;
        }
    ...
    public void setSecondTexture(Bitmap b) {
        if (UseDominantColorForFoldBack){
            ...
            int color = FoldPageBackColor;
            maskColor[SECOND_TEXTURE_ID][0] = Color.red(color);
            maskColor[SECOND_TEXTURE_ID][1] = Color.green(color);
            maskColor[SECOND_TEXTURE_ID][2] = Color.blue(color);
        }
...
//            maskColor[BACK_TEXTURE_ID][0] = color;
//            maskColor[BACK_TEXTURE_ID][1] = color;
//            maskColor[BACK_TEXTURE_ID][2] = color;
